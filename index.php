            ...
            <div class="col-lg-10 my-auto">
                <div class="card-group myShadow">
                    ...
                    <div class="card justify-content-center rounded-right myColor p-4">
                        ...
                        <p class="text-center font-weight-bolder text-light lead">Enter your personal details and start your journey with me!!</p>
            ...
            <div class="col-lg-10 my-auto">
                <div class="card-group myShadow">
                    ...
                    <div class="card rounded-right p-4" style="flex-grow:1.4;">
                        ...
                        <hr class="my-3">
                        <p class="lead text-center text-secondary">To reset yor password, enter the Regsitered e-mail address and we will send you the reset instructions on your e-mail!</p>
        ...
        $(document).ready(function() {
            ...
            $("#login-btn").click(function(e){
                if($("#login-form")[0].checkValidity()){
                    ...
                    $.ajax({
                        url: 'assets/php/action.php', method: 'post', data: $("#login-form").serialize()+'&action=login',
                        success:function(response){
