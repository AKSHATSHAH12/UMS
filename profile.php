                                ...
                                <div class="card border-success">
                                    ...
                                    <form action="#" method="post" class="px-3 mt-2" id="change-pass-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="cnewpass" placeholder="New password" class="form-control form-control-lg" id="cnewpass" required minlength="5">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="submit" name="changepass" value="Change Password" class="btn btn-success btn-block btn-lg id=" id="changePassBtn">
                                        </div>
                                    </form>
                                </div>
