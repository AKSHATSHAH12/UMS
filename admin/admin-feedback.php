    ...
    <div class="col-lg-12">
        <div class="card my-2 border-warning">
            <div class="card-header bg-warning text-white">
                <h4 class="m-0">Total Feedback From User</h4>
            </div>
            <div class="card-body">
            ...
            <div class="modal-body">
                <form method="post" action="#" class="px-3" id="feedback-reply-form">
                    <div class="form-group">
                        <textarea name="message" id="message" class="form-control" row="6" placeholder="Write Your Message Here.." required></textarea>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // GET The Current ROW UID and Feedback ID
        var uid;
        var fid;
