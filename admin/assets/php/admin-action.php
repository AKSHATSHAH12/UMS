    ...
    if ($data) {
        $output .= '<table class="table table-striped table-bordered text-center">
                ...
                foreach ($data as $row){
                    ...
                    <td>'.$row['verified'].'</td>
                    <td>
                    <a href="#" id="'.$row['id'].'" title="View Details" class="text-primary userDetailsIcon" data-toggle="modal" data-target="#showUsersDetailsModal"><i class="fas fa-info-circle fa-lg"></i></a>&nbsp;&nbsp;
...
if(isset($_POST['details_id'])){
    $id = $_POST['details_id'];
    $data = $admin->fetchUserDeatilsByID($id);

    echo json_encode($data);
}

// Handel DELETE AN USER AJAX REQUEST
...
// Handel EXPORT ALL USERS Inn EXCEl
